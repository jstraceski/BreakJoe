...
EXECUTABLE="./bin/breakjoe"        # Name of the final executable
...
if platform.system()=="Linux":
    ...
    INCLUDE_DIR="-I ./include/ -I ./include/IL -I ./include/freetype -I ./../common/thirdparty/glm/ -I/usr/include/SDL2"
    LIBRARIES="-lSDL2 -ldl ./lib/IL/*.so ./lib/freetype2/*.so"
    ...
    LIBRARIES="-F/Library/Frameworks -framework SDL2 dl SDL2_image SDL2_ttf"
    ...
    EXECUTABLE="lab.exe"
    LIBRARIES="-F/lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lSDL2_ttf -lIL -lILU -mwindows"
# (2)=================== Platform specific configuration ===================== #
